...
\textbf{Es stehen folgende zusätzliche Daten zu Verfügung:
}\begin{itemize}
  ...
  \item CINC: (Composite Index of National Capability) statistisches Ma"s für nationale Macht zwischen 0 und 1.
  \item Alliance: binäres Kantenattribut; militärisches Bündnis? (1:Ja, 0:Nein)
  \item DirectCont: binäres Kantenattribut; direkte Grenze? (1:Ja, 0:Nein)
\end{itemize}
