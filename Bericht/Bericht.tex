...
Netzwerkdaten ~ edges + mutual + gwidegree() + gwodegree() + gwesp() + gwdesp() + externe Kovariablen.
...
Bei diesem Modell ist der Fit allerdings sehr schlecht 
