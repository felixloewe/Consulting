...
\begin{itemize}
\item USA größtes Import- und Exportland
\item Deutschland zweitgrößtes Importland, drittgrößtes Exportland
\item Frankreich drittgrößtes Importland
\item Italien zweitgrößtes Exportland
\end{itemize}
\end{document}